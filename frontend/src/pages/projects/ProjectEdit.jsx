...
const ProjectEdit = () => {
  ...
  useEffect(() => {
    if (currentProject && String(currentProject._id) === String(id)) {
      setFormData({
        name: currentProject.name || "",
        category: currentProject.category || "Residential",
        description: currentProject.description || "",
        client: currentProject.client || "",
        startDate: toInputDate(currentProject.startDate),
        endDate: toInputDate(currentProject.endDate),
        budget:
          typeof currentProject.budget === "number"
            ? String(currentProject.budget)
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Update the construction project details.
        </p>
      </div>
